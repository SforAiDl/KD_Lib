...
class SelfTraining:
    ...
    def __init__(self, student_model, train_loader, val_loader, optimizer_student,
                 loss='MSE', temp=20.0, distil_weight=0.5, 
                 device='cpu', rkd_angle=None, rkd_dist=None, 
    ...
    def train_student(self, epochs=10, plot_losses=True, save_model=True, save_model_pth='./models/student.pth'):
        ...
        for ep in range(epochs):
            ...
            if self.log:
                ...
                self.writer.add_scalar('Training accuracy/Self Teacher', epoch_acc, epochs)
